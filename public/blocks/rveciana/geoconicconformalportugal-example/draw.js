...
var projection = d3_composite.geoConicConformalPortugal();
...
d3_request.json("world-50m.json", function(error, topojsonData) {
    var us = topojson.feature(topojsonData, topojsonData.objects.countries);
