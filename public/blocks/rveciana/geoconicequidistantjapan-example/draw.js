...
var projection = d3_composite.geoConicEquidistantJapan();
...
d3_request.json("japan.json", function(error, topojsonData) {
    var us = topojson.feature(topojsonData, topojsonData.objects.japan);
