...
pubDate: 2025-09-20
teaser: exercise-map.png
categories: python
tags: [valhalla, contextily, geopandas]
thumbnail: /images/python/exercise-map/twitter.png
twitter-card: summary
description: Create a Strava-like exercise map from GPS traces
---
...
![Final result](/images/python/exercise-map/final.png)
...
To run the script, you will need the API keys, which is what makes this method more complicated. Strava provides a [step by step tutorial here][keys]. Essentially, you have to create an _application_ with the proper permissions and you will be given the data. The permissions you need to give are:
...
![Initial result](/images/python/exercise-map/initial_gps_track.png)
...
![Initial result with background](/images/python/exercise-map/initial_gps_background.png)
...
- We format the request, where the parameters we can touch are in _meili_tail_
...
![Optimized path](/images/python/exercise-map/optimized_path.png)
